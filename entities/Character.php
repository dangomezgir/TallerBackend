...
namespace entities;
/*Aquí se definen todos los atributos del personaje, pero solo eso */
class Character {
    private $name = "";
    private $sex;
    private $bodyType;
    ...
    private $xp;
    private $race;
    private $playableClass;//1: Mago. 2: Guerrero. 3: Pícaro
    private $isAlive = true;
    private $isRightHanded = true;//Para saber si el arma se equipa en la mano izquierda o derecha.
    private $skills;
    private $weapon;

    public function __construct( $name, $sex, $bodyType, $race, $playableClass, 
    $str, $intl ,$agi ,$pDef ,$mDef ,$xp, $healtPoints,$maxHealtPoints, $level, $isAlive, $isRightHanded, $skills, $weapon)
    {
        $this->name = $name;
        $this->sex = $sex;
	...
	public function setIsRightHanded($isRightHanded){
        $this->isRightHanded = $isRightHanded;
        return $this;
	}
